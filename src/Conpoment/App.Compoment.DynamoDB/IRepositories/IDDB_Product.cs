...
namespace App.Compoment.Extension.DynamoDBExtension
{
    public interface IDDB_Product
    {
        ...
        /// <returns></returns>
        Task<FromDDB_Product> GetItemAsync(string sku, string currencyCode, string languageCode);
        ...
        /// <param name="currencyCode"></param>
        /// <returns></returns>
        Task<FromDDB_Product[]> BatchGetItemAsync(string[] skus, string currencyCode, string Language = "en");
        /// <summary>
        /// 获取表状态
        /// </summary>
        /// <typeparam name="TableName"></typeparam>
