...
namespace App.Compoment.Nswagger
{
    ...
    {
        public static IServiceCollection AddOpenApiDocumentationNswagger(this IServiceCollection services, IConfiguration config)
        {
            var settings = config.GetSection(nameof(NswaggerOptions)).Get<NswaggerOptions>();
