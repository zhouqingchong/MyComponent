...
namespace App.IdentityServer.Utility
{
    ...
    public class CustomHSJWTService : ICustomJWTService
    {
        ...
        public CustomHSJWTService(IOptionsMonitor<JwtOption> jwtTokenOptions)
        {
        ...
        public string GetToken(string UserName, string password)
        {
            ...
            SymmetricSecurityKey key = new SymmetricSecurityKey(Encoding.UTF8.GetBytes(_JWTTokenOptions.SecretKey));
